...
//
//
// 1. A. Babylonian Ark Tablet - Learned culture and boat dimensions: https://www.youtube.com/watch?v=jqBQKHl5PeA&t=1635s
//
// *  Front side
...
// 14 "Which were one parsiktu-vessel thick, ten nindan long"										6.1388853+(0.030) @ 0.01 length	or 0.1*0.3=0.03				=> 6.1688853      *line 14, 1,10:110 =6; 6.16
...
// 21 "And I poured 3,600 sutu of iooy-bitumen within."												6.1587853-0.0000125 = 6.1587728				    			=> 6.1587728	  *line 21, 3600/28800 = 1/8 = 0.[12]5; "within": past the last used place value 0.000[0] => 0.0000125
// 22 "The bitumen did not come to the surface (lit. up to me]; (so) I added five fingers of lard," 6.1587728+0.0000005 = 6.1587733 						    => 6.1587733	  *line 22 "up to me":  0.000[0] (2+2 & 2*2=4 place values), add 5*0.001 (finger) => 0.0000005
// 23 "I ordered the kilns to be loaded... in equal measure; 										6.1587733-0.0000023	= 6.1587710071							=> 6.1587710	  *line 23 = "in equal measure":verse:line 23 & adjust at 2+3 place values => 0.0000023 
...
// 25 "... (= I completed the mixture).																615.8771                									=> 615.8771       *line 25 = all change numbers summed: 1+4+4+3+3+9+1+1+1+2+5+5+2+3+[1] = 45 : 0.25 of 180 degrees = 45
// 26 ...
// 27 "Going between her ribs;"
// 28 ...
// 29 "... the iooy-bitumen ..."																	*Front side formula: (2*pi-0.14430+0.03-(0.009)-0.001-0.0001-0.0000125+0.0000005-0.0000023)*100 = 615.8771....
//																									*Sum (1 to 29)*29 = 435*29 = 12,615
//
// *  Back side
// 1  "I applied (?) the outside kupru-bitumen from the kilns,"									
// 2  "Out of the 120 gur-measures, which the workmen had put to one side."							6.1587710 => move decimal 1,2[0:.]                          => 615.8771       *line 1,2 (place-value check)  
//     			                                                                                    6.1587710 => move decimal 120: 60,60[.]                     => 615.8771       *120 = 60 + 60 (2 full Babylonian base 60 counts) : 2 place values 
...
//   rearrange:    			      3 25, 615.87[7 digits]1
// * Major work relation:  
...
// 	"To the fourth, to which you must travel seven leagues" 					0.7*10^4 = 7000  -> 5,700 lightyears away: Possibly Eagle Nebula, contains the "pillars of creation"
...
//																							lines 18,19,22: 18*1+19*1+22*5 = 147 & 0.001 => 0.7*10^4 (distance equation equivalency)
//																								  18*19*22 = 7,524 & 0.001 => 0075[full Babylonian day]
...
//      1 , 6 , 10, 50 ,  8 , 1 : 615.8              *Note: left side has same values 6, 10, 50, 8 as Other old magic book
//                              : 615.877            *Equivalency: Pattern B (1.17...) => 11*7=77 & Word 1 Value 1 : 7 => 11*7=77 & [1+6+8+10+50+1]+[Word : 1] = 77
//                              : 615.8771007        *Remainders: Value 7 : 1 => append 1007
//
//                      Word      : 1                *METHOD B
//                      Value   7 : 1                *Pattern A: 23/27=0.851...; Pattern B: 27/23= 1.17...    
// 80 + 1 + 6 + 8 + 10 + 50 + 1 = 156                                                                                                                    
//      1 , 6 ,10 , 50 ,  8 , 1 : 615,08             *Make LIKE Pattern A (0.851...) => order to pattern "158" 
//          6 ,10 , 50 ,  8 , 1 : 615.81             *Make equal both sides
//                       615.87 : 615.87             *Equivalency: Pattern B (1.17...) & Word 1 Value 1 : 7 => SWITCH 7 for both 1s
//
// "the ark"    Word     : 5
//              Value  5 : 1                         *note: average = mesos (A.Greek => 40+5+200+70+200=515) & average = mutawassit (Arabic => 40+400+6+60+9=515); however it is broken 5:1:5*
// 1 + 30 + 80 + 30 + 20 = 161                       
